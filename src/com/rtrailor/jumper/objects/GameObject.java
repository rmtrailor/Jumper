 ...
 *  Class:	GameObject
 *  -------------------
 *  This abstract is the class that all objects in the game will inherit from.
 *
 *  All game objects will are given x and y coordinate values that specify where the objects
